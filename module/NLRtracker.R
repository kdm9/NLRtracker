...
NLR_structure %>%
  ...
  write.table(paste0(outdir, "/", outbase, "_NLRtracker.tsv"), sep="\t", row.names = FALSE, col.names = TRUE, na = "", quote=FALSE)
...
NLR_associated %>%
  write.table(paste0(outdir, "/", outbase, "_NLR-associated.lst"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)

NLR_associated %>%
  left_join(Annotation, by = "seqname") %>%
  select(seqname, source, feature, start, end, score, strand, frame, attribute) %>%
  write.table(paste0(outdir, "/", outbase, "_NLR-associated.gff3"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
AA %>%
  ...
  select(value) %>%
  write.table(paste0(outdir, "/", outbase, "_NLR_associated.fasta"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
NLR %>%
  write.table(paste0(outdir, "/", outbase, "_NLR.lst"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
NLR %>%
  ...
  select(seqname, source, feature, start, end, score, strand, frame, attribute) %>%
  write.table(paste0(outdir, "/", outbase, "_NLR.gff3"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
AA %>%
  ...
  pivot_longer(cols = c(seqname, sequence)) %>%
  select(value) %>%
  write.table(paste0(outdir, "/", outbase, "_NLR.fasta"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
NLR_Domains %>%
  ...
  pivot_longer(cols = c(seqname, sequence)) %>%
  select(value) %>%
  write.table(paste0(outdir, "/", outbase, "_NBARC.fasta"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
NLR_Domains_DEDUP %>%
  ...
  pivot_longer(cols = c(seqname, sequence)) %>%
  select(value) %>%
  write.table(paste0(outdir, "/", outbase, "_NBARC_deduplictated.fasta"), sep="\t", row.names = FALSE, col.names = FALSE, na = "", quote=FALSE)
...
write.table(NLR_Domains, file = paste0(outdir, "/", outbase, "_Domains.tsv"), sep="\t", row.names = FALSE, col.names = TRUE, na = "", quote=FALSE)
...
write.table(iTOL, file = paste0(outdir, "/", outbase, "_iTOL.txt"), sep="", row.names = FALSE, col.names = FALSE, na = "", quote = FALSE)

write.table(iTOL_dedup, file = paste0(outdir, "/", outbase, "_iTOL_dedup.txt"), sep="", row.names = FALSE, col.names = FALSE, na = "", quote = FALSE)
